...
rpicomponents::Lcd1602::Lcd1602(const rpicomponents::Pcf8574& pcf) : Component(COMPONENT_LCD1602), pcf_{pcf}, 
...
const rpicomponents::Pcf8574& rpicomponents::Lcd1602::GetPcf() const
{
	return pcf_;
}
