...
EnablePinStruct rpicomponents::Motor::GetEnablePins() const
{
	auto pins = l293d_.GetEnablePins();
	return pins;
}

InPinStruct rpicomponents::Motor::GetInPins() const
{
	auto pins = l293d_.GetInPins();
	return pins;
}

rpicomponents::Motor::Motor(const EnablePinStruct& enablePins, const InPinStruct& in_pins) : l293d_{ std::unique_ptr<rpicomponents:L293D>(new L293D(enablePins, in_pins))}
{
}
...
rpicomponents::Motor::Motor(int enable_pin1, int enable_pin2, rpicomponents::pin::PIN_MODE enable_pin1_mode, rpicomponents::pin::PIN_MODE enable_pin2_mode, 
	int max_output_enable_pin1, int max_output_enable_pin2, int in_pin1, int in_pin2, int in_pin3, int in_pin4) :
